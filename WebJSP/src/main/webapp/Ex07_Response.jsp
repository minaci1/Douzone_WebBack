...
<!--
	...
	Server	-> Client (response 응답 >> 결과 >> 클라이언트에게 전달 (
			    (response)응답 : 클라이언트 브라우저가 해석 가능한 형태로(text,html,css,javascript)
	...
	response.sendRedirect("이동할 주소") >> 해석의 주체 서버 (랜더링 (바뀐다)) >> 
	****javascript 페이지 이동 >> location.href="이동할 주소"*****
	****웹 브라우져에서 F5의 (새로고침) >> 서버로부터 갱신된 페이지를 받겠다....
 -->
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	2. sendRedirect : response 객체의 함수<br>
	<%
