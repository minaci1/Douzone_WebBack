...
<%
	...
	String  realcontextpath = application.getRealPath(request.getContextPath()); //CP : /WebJSP
	out.print("getRealPath 을 실제 경로 "+ realcontextpath+"<br>");
	
	String  filepath = application.getRealPath(realcontextpath); //
	out.print("File Real Path 을 실제 경로 "+ filepath+"<br>");
	...
	String cp = request.getContextPath(); // CP : 프로젝트 명
	String sp = request.getServletPath(); // SP : 패키지 + 파일명
	System.out.println("URL : " + url); //URL : http://localhost:8090/WebJSP/Ex09_WebApp_RealPath.jsp
	System.out.println("URI : " + uri); //URI : /WebJSP/Ex09_WebApp_RealPath.jsp
	System.out.println("CP : " + cp); //CP : /WebJSP
	System.out.println("SP : " + sp); //SP : /Ex09_WebApp_RealPath.jsp
