...
request.getParameter("ID") >> 	${param.ID}
 ...
 <!-- 
 http://localhost:8090/WebJSP_JSTL/Ex04_EL_JSTL.jsp?ID=hong&age=100
 http://localhost:8090/WebJSP_JSTL/Ex04_EL_JSTL.jsp?ID=hong&age=15
